import{r as s}from"./runtimeStorage-DhtagKFa.js";import{C as d,R as E}from"./cotSteps-D11NnCCI.js";import{a0 as g}from"./vendor-core-D-WDeQ4E.js";const i="dnd-reasoning-reveal-folded";function R(){try{return typeof s<"u"&&s.getItem(i)==="1"}catch{return!1}}const _=g(R());function v(e){_.value=e;try{e?s.setItem(i,"1"):s.removeItem(i)}catch{}}const n=Object.fromEntries([...d,...E].filter(e=>e.label).map(e=>[e.tag,e.label])),m=Object.fromEntries([...d,...E].map(e=>[e.tag,e.sensitivity])),p="〔内幕推演已折叠——避免剧透〕";function A(e){let t=String(e||"");const c=_.value;t=t.replace(/<([A-Za-z0-9_一-鿿]+)\s*>([\s\S]*?)<\/\1\s*>/g,(l,a,o)=>{const f=n[a]?`
【${n[a]}】`:`
