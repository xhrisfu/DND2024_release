import{mt as b}from"./eventTargetElement-BCFfm8Ta.js";const v=[{tag:"intent",label:"玩家意图解析",prompt:`只从最后一条【玩家本轮输入】识别本轮任务，不能把历史对话中的动作当作新指令。
...
判断玩家的口吻是否是命令式口吻，命令式口吻（"守卫放我进去了"）一律降格为"尝试"：`,sensitivity:"visible",resident:!0},{tag:"stop_check",label:"剧情分析",prompt:`概括最近20轮的剧情发生了什么（依据【近期剧情梗概】与上文对话历史，没有的别编）：
                 ...
                 玩家实际移动到相邻区域用 move_party 的 toLocationId；长途分段旅行才用 travel_to。同一实际区域的叙事焦点变化可以用 toSceneId，但不是旅行，也不代表开战。
